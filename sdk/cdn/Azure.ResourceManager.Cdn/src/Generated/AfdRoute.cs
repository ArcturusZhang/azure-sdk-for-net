...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class AfdRoute : ArmResource
    {
        ...
        internal AfdRoute(ArmResource options, AfdRouteData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AfdRoute.GetAvailableLocations");
            scope.Start();
            try
            {
