...
namespace Insights
{
    ...
    public partial class AutoscaleSettingResourceCollection : ArmCollection, IEnumerable<AutoscaleSettingResource>, IAsyncEnumerable<AutoscaleSettingResource>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AutoscaleSettingResourceCollection"/> class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal AutoscaleSettingResourceCollection(ArmResource parent) : base(parent)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            ClientOptions.TryGetApiVersion(AutoscaleSettingResource.ResourceType, out string apiVersion);
        ...
        public virtual AutoscaleSettingResourceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string autoscaleSettingName, AutoscaleSettingResourceData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AutoscaleSettingResourceCreateOrUpdateOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="autoscaleSettingName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<AutoscaleSettingResourceCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string autoscaleSettingName, AutoscaleSettingResourceData parameters, CancellationToken cancellationToken = default)
        {
            if (autoscaleSettingName == null)
            {
                throw new ArgumentNullException(nameof(autoscaleSettingName));
        ...
        public virtual Response<AutoscaleSettingResource> Get(string autoscaleSettingName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Azure.Response.FromValue(new AutoscaleSettingResource(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Response<AutoscaleSettingResource> GetIfExists(string autoscaleSettingName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                if (response.Value == null)
                    return Azure.Response.FromValue<AutoscaleSettingResource>(null, response.GetRawResponse());
        ...
        public virtual Response<bool> Exists(string autoscaleSettingName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AutoscaleSettingResourceCollection.Exists");
            scope.Start();
            try
            {
        ...
        // Builders.
        // public ArmBuilder<Azure.Core.ResourceIdentifier, AutoscaleSettingResource, AutoscaleSettingResourceData> Construct() { }
    }
}
