...
namespace Insights
{
    ...
    public partial class ActivityLogAlertResourceCollection : ArmCollection, IEnumerable<ActivityLogAlertResource>, IAsyncEnumerable<ActivityLogAlertResource>
    {
        ...
        internal ActivityLogAlertResourceCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(ActivityLogAlertResource.ResourceType, out string apiVersion);
        ...
        public virtual ActivityLogAlertResourceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string activityLogAlertName, ActivityLogAlertResourceData activityLogAlert, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ActivityLogAlertResourceCreateOrUpdateOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="activityLogAlertName"/> or <paramref name="activityLogAlert"/> is null. </exception>
        public async virtual Task<ActivityLogAlertResourceCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string activityLogAlertName, ActivityLogAlertResourceData activityLogAlert, CancellationToken cancellationToken = default)
        {
            if (activityLogAlertName == null)
            {
                throw new ArgumentNullException(nameof(activityLogAlertName));
