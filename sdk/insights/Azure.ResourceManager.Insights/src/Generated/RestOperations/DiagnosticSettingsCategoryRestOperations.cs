...
namespace Insights
{
    internal partial class DiagnosticSettingsCategoryRestOperations
    {
        ...
        public DiagnosticSettingsCategoryRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
        ...
        public async Task<Response<DiagnosticSettingsCategoryResourceData>> GetAsync(string resourceUri, string name, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                ...
                case 404:
                    return Azure.Response.FromValue((DiagnosticSettingsCategoryResourceData)null, message.Response);
                default:
