...
namespace Insights
{
    internal partial class MetricDefinitionsRestOperations
    {
        ...
        public MetricDefinitionsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
