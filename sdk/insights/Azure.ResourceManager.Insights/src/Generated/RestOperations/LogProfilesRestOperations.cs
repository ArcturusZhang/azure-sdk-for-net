...
namespace Insights
{
    internal partial class LogProfilesRestOperations
    {
        ...
        public LogProfilesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ArmClientOptions options, Uri endpoint = null, string apiVersion = default)
        {
            this.endpoint = endpoint ?? new Uri("https://management.azure.com");
            this.apiVersion = apiVersion ?? "2016-03-01";
        ...
        public async Task<Azure.Response> DeleteAsync(string subscriptionId, string logProfileName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="logProfileName"/> is null. </exception>
        public Azure.Response Delete(string subscriptionId, string logProfileName, CancellationToken cancellationToken = default)
        {
            if (subscriptionId == null)
            {
                throw new ArgumentNullException(nameof(subscriptionId));
        ...
        public async Task<Response<LogProfileResourceData>> GetAsync(string subscriptionId, string logProfileName, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                ...
                case 404:
                    return Azure.Response.FromValue((LogProfileResourceData)null, message.Response);
                default:
                    throw await _clientDiagnostics.CreateRequestFailedExceptionAsync(message.Response).ConfigureAwait(false);
            }
        }
