...
namespace Insights
{
    ...
    public partial class MetricAlertResourceCollection : ArmCollection, IEnumerable<MetricAlertResource>, IAsyncEnumerable<MetricAlertResource>
    {
        ...
        internal MetricAlertResourceCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(MetricAlertResource.ResourceType, out string apiVersion);
        ...
        public virtual MetricAlertResourceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string ruleName, MetricAlertResourceData parameters, CancellationToken cancellationToken = default)
        {
            if (ruleName == null)
            {
            ...
            try
            {
                ...
                var operation = new MetricAlertResourceCreateOrUpdateOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ruleName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<MetricAlertResourceCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string ruleName, MetricAlertResourceData parameters, CancellationToken cancellationToken = default)
        {
            if (ruleName == null)
            {
                throw new ArgumentNullException(nameof(ruleName));
