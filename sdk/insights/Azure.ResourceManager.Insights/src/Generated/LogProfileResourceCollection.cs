...
namespace Insights
{
    ...
    public partial class LogProfileResourceCollection : ArmCollection, IEnumerable<LogProfileResource>, IAsyncEnumerable<LogProfileResource>
    {
        ...
        internal LogProfileResourceCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(LogProfileResource.ResourceType, out string apiVersion);
        ...
        public virtual LogProfileResourceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string logProfileName, LogProfileResourceData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new LogProfileResourceCreateOrUpdateOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="logProfileName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<LogProfileResourceCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string logProfileName, LogProfileResourceData parameters, CancellationToken cancellationToken = default)
        {
            if (logProfileName == null)
            {
                throw new ArgumentNullException(nameof(logProfileName));
