...
namespace Insights
{
    ...
    public partial class AlertRuleResourceCollection : ArmCollection, IEnumerable<AlertRuleResource>, IAsyncEnumerable<AlertRuleResource>
    {
        ...
        internal AlertRuleResourceCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(AlertRuleResource.ResourceType, out string apiVersion);
        ...
        public virtual AlertRuleResourceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string ruleName, AlertRuleResourceData parameters, CancellationToken cancellationToken = default)
        {
            if (ruleName == null)
            {
            ...
            try
            {
                ...
                var operation = new AlertRuleResourceCreateOrUpdateOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ruleName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<AlertRuleResourceCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string ruleName, AlertRuleResourceData parameters, CancellationToken cancellationToken = default)
        {
            if (ruleName == null)
            {
                throw new ArgumentNullException(nameof(ruleName));
