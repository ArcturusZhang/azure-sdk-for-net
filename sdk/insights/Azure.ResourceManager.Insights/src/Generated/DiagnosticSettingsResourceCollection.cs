...
namespace Insights
{
    ...
    public partial class DiagnosticSettingsResourceCollection : ArmCollection, IEnumerable<DiagnosticSettingsResource>, IAsyncEnumerable<DiagnosticSettingsResource>
    {
        ...
        internal DiagnosticSettingsResourceCollection(ArmResource parent) : base(parent)
        {
            ...
            ClientOptions.TryGetApiVersion(DiagnosticSettingsResource.ResourceType, out string apiVersion);
        ...
        public virtual DiagnosticSettingsResourceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string name, DiagnosticSettingsResourceData parameters, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
            ...
            try
            {
                ...
                var operation = new DiagnosticSettingsResourceCreateOrUpdateOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<DiagnosticSettingsResourceCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string name, DiagnosticSettingsResourceData parameters, CancellationToken cancellationToken = default)
        {
            if (name == null)
            {
                throw new ArgumentNullException(nameof(name));
