...
namespace Insights
{
    ...
    public partial class MetricAlertResource : ArmResource
    {
        ...
        internal MetricAlertResource(ArmResource options, MetricAlertResourceData data) : base(options, data.Id)
        {
            ...
            _metricAlertsStatusRestClient = new MetricAlertsStatusRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
#if DEBUG
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<MetricAlertResourceDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MetricAlertResourceDeleteOperation(response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual MetricAlertResourceDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("MetricAlertResource.Delete");
            scope.Start();
            try
