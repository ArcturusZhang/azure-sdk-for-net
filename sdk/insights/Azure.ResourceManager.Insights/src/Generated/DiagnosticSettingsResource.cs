...
namespace Insights
{
    ...
    public partial class DiagnosticSettingsResource : ArmResource
    {
        ...
        internal DiagnosticSettingsResource(ArmResource options, DiagnosticSettingsResourceData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("DiagnosticSettingsResource.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<DiagnosticSettingsResourceDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DiagnosticSettingsResourceDeleteOperation(response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DiagnosticSettingsResourceDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DiagnosticSettingsResource.Delete");
            scope.Start();
            try
