...
namespace Insights
{
    /// <summary> A Class representing a LogProfileResource along with the instance operations that can be performed on it. </summary>
    public partial class LogProfileResource : ArmResource
    {
        ...
        internal LogProfileResource(ArmResource options, LogProfileResourceData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        internal LogProfileResource(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            ClientOptions.TryGetApiVersion(ResourceType, out string apiVersion);
            _logProfilesRestClient = new LogProfilesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal LogProfileResource(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            ClientOptions.TryGetApiVersion(ResourceType, out string apiVersion);
            _logProfilesRestClient = new LogProfilesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
        ...
        public async virtual Task<Response<LogProfileResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("LogProfileResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("LogProfileResource.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<LogProfileResourceDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("LogProfileResource.Delete");
            scope.Start();
            try
            {
                var response = await _logProfilesRestClient.DeleteAsync(Id.SubscriptionId, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new LogProfileResourceDeleteOperation(response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual LogProfileResourceDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("LogProfileResource.Delete");
            scope.Start();
            try
        ...
        public async virtual Task<Response<LogProfileResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("LogProfileResource.AddTag");
            scope.Start();
            try
            {
                ...
                return Azure.Response.FromValue(new LogProfileResource(this, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async virtual Task<Response<LogProfileResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            if (tags == null)
            {
            ...
            using var scope = _clientDiagnostics.CreateScope("LogProfileResource.SetTags");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<LogProfileResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            if (string.IsNullOrWhiteSpace(key))
            {
                throw new ArgumentNullException(nameof(key), $"{nameof(key)} provided cannot be null or a whitespace.");
            ...
            using var scope = _clientDiagnostics.CreateScope("LogProfileResource.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await TagResource.GetAsync(cancellationToken).ConfigureAwait(false);
        ...
        public async virtual Task<Response<LogProfileResource>> UpdateAsync(LogProfileResourcePatch logProfilesResource, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("LogProfileResource.Update");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="logProfilesResource"/> is null. </exception>
        public virtual Response<LogProfileResource> Update(LogProfileResourcePatch logProfilesResource, CancellationToken cancellationToken = default)
        {
            if (logProfilesResource == null)
            {
                throw new ArgumentNullException(nameof(logProfilesResource));
