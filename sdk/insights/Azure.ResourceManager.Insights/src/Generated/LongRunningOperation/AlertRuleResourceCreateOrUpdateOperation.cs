...
namespace Insights.Models
{
    ...
    public partial class AlertRuleResourceCreateOrUpdateOperation : Operation<AlertRuleResource>
    {
        private readonly OperationOrResponseInternals<AlertRuleResource> _operation;

        /// <summary> Initializes a new instance of AlertRuleResourceCreateOrUpdateOperation for mocking. </summary>
        protected AlertRuleResourceCreateOrUpdateOperation()
        {
        }

        internal AlertRuleResourceCreateOrUpdateOperation(ArmResource operationsBase, Response<AlertRuleResourceData> response)
        {
