...
namespace Insights.Models
{
    ...
    public partial class ActivityLogAlertResourceDeleteOperation : Operation
    {
        private readonly OperationOrResponseInternals _operation;

        /// <summary> Initializes a new instance of ActivityLogAlertResourceDeleteOperation for mocking. </summary>
        protected ActivityLogAlertResourceDeleteOperation()
        {
        }

        internal ActivityLogAlertResourceDeleteOperation(Azure.Response response)
        {
