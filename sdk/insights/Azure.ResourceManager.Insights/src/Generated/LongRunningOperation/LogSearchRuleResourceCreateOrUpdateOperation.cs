...
namespace Insights.Models
{
    ...
    public partial class LogSearchRuleResourceCreateOrUpdateOperation : Operation<LogSearchRuleResource>
    {
        private readonly OperationOrResponseInternals<LogSearchRuleResource> _operation;

        /// <summary> Initializes a new instance of LogSearchRuleResourceCreateOrUpdateOperation for mocking. </summary>
        protected LogSearchRuleResourceCreateOrUpdateOperation()
        {
        }

        internal LogSearchRuleResourceCreateOrUpdateOperation(ArmResource operationsBase, Response<LogSearchRuleResourceData> response)
        {
