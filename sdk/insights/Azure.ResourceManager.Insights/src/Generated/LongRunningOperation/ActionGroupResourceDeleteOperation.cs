...
namespace Insights.Models
{
    ...
    public partial class ActionGroupResourceDeleteOperation : Operation
    {
        private readonly OperationOrResponseInternals _operation;

        /// <summary> Initializes a new instance of ActionGroupResourceDeleteOperation for mocking. </summary>
        protected ActionGroupResourceDeleteOperation()
        {
        }

        internal ActionGroupResourceDeleteOperation(Azure.Response response)
        {
