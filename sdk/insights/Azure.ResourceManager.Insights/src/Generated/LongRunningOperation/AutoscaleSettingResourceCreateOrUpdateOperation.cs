...
namespace Insights.Models
{
    ...
    public partial class AutoscaleSettingResourceCreateOrUpdateOperation : Operation<AutoscaleSettingResource>
    {
        private readonly OperationOrResponseInternals<AutoscaleSettingResource> _operation;

        /// <summary> Initializes a new instance of AutoscaleSettingResourceCreateOrUpdateOperation for mocking. </summary>
        protected AutoscaleSettingResourceCreateOrUpdateOperation()
        {
        }

        internal AutoscaleSettingResourceCreateOrUpdateOperation(ArmResource operationsBase, Response<AutoscaleSettingResourceData> response)
        {
