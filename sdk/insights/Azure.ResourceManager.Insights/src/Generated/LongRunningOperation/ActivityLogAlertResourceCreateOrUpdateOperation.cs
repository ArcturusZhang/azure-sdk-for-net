...
namespace Insights.Models
{
    ...
    public partial class ActivityLogAlertResourceCreateOrUpdateOperation : Operation<ActivityLogAlertResource>
    {
        private readonly OperationOrResponseInternals<ActivityLogAlertResource> _operation;

        /// <summary> Initializes a new instance of ActivityLogAlertResourceCreateOrUpdateOperation for mocking. </summary>
        protected ActivityLogAlertResourceCreateOrUpdateOperation()
        {
        }

        internal ActivityLogAlertResourceCreateOrUpdateOperation(ArmResource operationsBase, Response<ActivityLogAlertResourceData> response)
        {
