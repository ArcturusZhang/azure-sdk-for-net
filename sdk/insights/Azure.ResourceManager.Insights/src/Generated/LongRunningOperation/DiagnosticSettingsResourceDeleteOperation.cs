...
namespace Insights.Models
{
    ...
    public partial class DiagnosticSettingsResourceDeleteOperation : Operation
    {
        private readonly OperationOrResponseInternals _operation;

        /// <summary> Initializes a new instance of DiagnosticSettingsResourceDeleteOperation for mocking. </summary>
        protected DiagnosticSettingsResourceDeleteOperation()
        {
        }

        internal DiagnosticSettingsResourceDeleteOperation(Azure.Response response)
        {
