...
namespace Insights.Models
{
    ...
    public partial class LogProfileResourceCreateOrUpdateOperation : Operation<LogProfileResource>
    {
        private readonly OperationOrResponseInternals<LogProfileResource> _operation;

        /// <summary> Initializes a new instance of LogProfileResourceCreateOrUpdateOperation for mocking. </summary>
        protected LogProfileResourceCreateOrUpdateOperation()
        {
        }

        internal LogProfileResourceCreateOrUpdateOperation(ArmResource operationsBase, Response<LogProfileResourceData> response)
        {
