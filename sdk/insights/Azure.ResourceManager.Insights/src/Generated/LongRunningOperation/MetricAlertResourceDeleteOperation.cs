...
namespace Insights.Models
{
    ...
    public partial class MetricAlertResourceDeleteOperation : Operation
    {
        private readonly OperationOrResponseInternals _operation;

        /// <summary> Initializes a new instance of MetricAlertResourceDeleteOperation for mocking. </summary>
        protected MetricAlertResourceDeleteOperation()
        {
        }

        internal MetricAlertResourceDeleteOperation(Azure.Response response)
        {
