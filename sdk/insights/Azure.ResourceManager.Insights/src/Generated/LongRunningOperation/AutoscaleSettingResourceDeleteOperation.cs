...
namespace Insights.Models
{
    ...
    public partial class AutoscaleSettingResourceDeleteOperation : Operation
    {
        private readonly OperationOrResponseInternals _operation;

        /// <summary> Initializes a new instance of AutoscaleSettingResourceDeleteOperation for mocking. </summary>
        protected AutoscaleSettingResourceDeleteOperation()
        {
        }

        internal AutoscaleSettingResourceDeleteOperation(Azure.Response response)
        {
