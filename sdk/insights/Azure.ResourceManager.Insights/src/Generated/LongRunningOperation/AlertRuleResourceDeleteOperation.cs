...
namespace Insights.Models
{
    ...
    public partial class AlertRuleResourceDeleteOperation : Operation
    {
        private readonly OperationOrResponseInternals _operation;

        /// <summary> Initializes a new instance of AlertRuleResourceDeleteOperation for mocking. </summary>
        protected AlertRuleResourceDeleteOperation()
        {
        }

        internal AlertRuleResourceDeleteOperation(Azure.Response response)
        {
