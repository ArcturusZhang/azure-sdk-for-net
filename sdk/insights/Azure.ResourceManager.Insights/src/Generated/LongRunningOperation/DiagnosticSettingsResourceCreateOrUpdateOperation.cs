...
namespace Insights.Models
{
    ...
    public partial class DiagnosticSettingsResourceCreateOrUpdateOperation : Operation<DiagnosticSettingsResource>
    {
        private readonly OperationOrResponseInternals<DiagnosticSettingsResource> _operation;

        /// <summary> Initializes a new instance of DiagnosticSettingsResourceCreateOrUpdateOperation for mocking. </summary>
        protected DiagnosticSettingsResourceCreateOrUpdateOperation()
        {
        }

        internal DiagnosticSettingsResourceCreateOrUpdateOperation(ArmResource operationsBase, Response<DiagnosticSettingsResourceData> response)
        {
