...
namespace Insights.Models
{
    ...
    public partial class ActionGroupResourceCreateOrUpdateOperation : Operation<ActionGroupResource>
    {
        private readonly OperationOrResponseInternals<ActionGroupResource> _operation;

        /// <summary> Initializes a new instance of ActionGroupResourceCreateOrUpdateOperation for mocking. </summary>
        protected ActionGroupResourceCreateOrUpdateOperation()
        {
        }

        internal ActionGroupResourceCreateOrUpdateOperation(ArmResource operationsBase, Response<ActionGroupResourceData> response)
        {
