...
namespace Insights.Models
{
    ...
    public partial class LogSearchRuleResourceDeleteOperation : Operation
    {
        private readonly OperationOrResponseInternals _operation;

        /// <summary> Initializes a new instance of LogSearchRuleResourceDeleteOperation for mocking. </summary>
        protected LogSearchRuleResourceDeleteOperation()
        {
        }

        internal LogSearchRuleResourceDeleteOperation(Azure.Response response)
        {
