...
namespace Azure.ResourceManager.ContainerServiceFleet.Models
{
    ...
    public static partial class ArmContainerServiceFleetModelFactory
    {
        ...
        /// <returns> A new <see cref="Models.ContainerServiceFleetLabelSelector"/> instance for mocking. </returns>
        public static ContainerServiceFleetLabelSelector ContainerServiceFleetLabelSelector(IDictionary<string, string> matchLabels = default, IEnumerable<ContainerServiceFleetLabelSelectorRequirement> matchExpressions = default)
        {
            ...
            return new ContainerServiceFleetLabelSelector(matchLabels, matchExpressions.ToList(), additionalBinaryDataProperties: null);
        }
        ...
        /// <returns> A new <see cref="Models.ContainerServiceFleetLabelSelectorRequirement"/> instance for mocking. </returns>
        public static ContainerServiceFleetLabelSelectorRequirement ContainerServiceFleetLabelSelectorRequirement(string key = default, ContainerServiceFleetLabelSelectorOperator @operator = default, IEnumerable<string> values = default)
        {
            values ??= new ChangeTrackingList<string>();

            return new ContainerServiceFleetLabelSelectorRequirement(key, @operator, values.ToList(), additionalBinaryDataProperties: null);
        }
