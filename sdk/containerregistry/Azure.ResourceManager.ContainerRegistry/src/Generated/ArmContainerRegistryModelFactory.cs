    ...
    public static partial class ArmContainerRegistryModelFactory
    {
        ...
        public static ContainerRegistryPrivateLinkResourceData ContainerRegistryPrivateLinkResourceData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string groupId = default, IEnumerable<string> requiredMembers = default, IEnumerable<string> requiredZoneNames = default)
        {
            return new ContainerRegistryPrivateLinkResourceData(
                ...
                systemData,
                additionalBinaryDataProperties: null,
                groupId is null ? default : new ContainerRegistryPrivateLinkResourceProperties(groupId, (requiredMembers ?? new ChangeTrackingList<string>()).ToList(), (requiredZoneNames ?? new ChangeTrackingList<string>()).ToList(), null));
        }
        ...
        public static ConnectedRegistryData ConnectedRegistryData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, ContainerRegistryProvisioningState? provisioningState = default, ConnectedRegistryMode? mode = default, string version = default, ConnectedRegistryConnectionState? connectionState = default, DateTimeOffset? lastActivityOn = default, ConnectedRegistryParent parent = default, IEnumerable<ResourceIdentifier> clientTokenIds = default, ConnectedRegistryLoginServer loginServer = default, ConnectedRegistryLogging logging = default, IEnumerable<ConnectedRegistryStatusDetail> statusDetails = default, IEnumerable<string> notificationsList = default, GarbageCollectionProperties garbageCollection = default, ContainerRegistrySyncResult registrySyncResult = default, ConnectedRegistryActivationStatus? activationStatus = default)
        {
            return new ConnectedRegistryData(
                ...
                systemData,
                additionalBinaryDataProperties: null,
                provisioningState is null && mode is null && version is null && connectionState is null && lastActivityOn is null && loginServer is null && logging is null && garbageCollection is null && registrySyncResult is null && activationStatus is null ? default : new ConnectedRegistryProperties(
                    provisioningState,
        ...
        public static ScopeMapData ScopeMapData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string description = default, string scopeMapType = default, DateTimeOffset? createdOn = default, ContainerRegistryProvisioningState? provisioningState = default, IEnumerable<string> actions = default)
        {
            return new ScopeMapData(
                ...
                systemData,
                additionalBinaryDataProperties: null,
                description is null && scopeMapType is null && createdOn is null && provisioningState is null ? default : new ScopeMapProperties(
                    description,
                    scopeMapType,
                    createdOn,
                    provisioningState,
        ...
        public static ContainerRegistryExportPipelineData ContainerRegistryExportPipelineData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, ContainerRegistryExportPipelineTargetProperties target = default, IEnumerable<PipelineOption> options = default, ContainerRegistryProvisioningState? provisioningState = default, AzureLocation? location = default, ManagedServiceIdentity identity = default)
        {
            return new ContainerRegistryExportPipelineData(
                ...
                systemData,
                additionalBinaryDataProperties: null,
                provisioningState is null ? default : new ExportPipelineProperties(target, (options ?? new ChangeTrackingList<PipelineOption>()).ToList(), provisioningState, null),
                location,
                identity);
        }
        ...
        public static ContainerRegistryImportPipelineData ContainerRegistryImportPipelineData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, ContainerRegistryImportPipelineSourceProperties source = default, IEnumerable<PipelineOption> options = default, ContainerRegistryProvisioningState? provisioningState = default, ContainerRegistryTriggerStatus? sourceTriggerStatus = default, AzureLocation? location = default, ManagedServiceIdentity identity = default)
        {
            return new ContainerRegistryImportPipelineData(
                ...
                systemData,
                additionalBinaryDataProperties: null,
                provisioningState is null && sourceTriggerStatus is null ? default : new ImportPipelineProperties(source, new PipelineTriggerProperties(new PipelineSourceTriggerProperties(sourceTriggerStatus.GetValueOrDefault(), null), null), (options ?? new ChangeTrackingList<PipelineOption>()).ToList(), provisioningState, null),
                location,
                identity);
        }
        ...
        public static ContainerRegistryWebhookData ContainerRegistryWebhookData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, IDictionary<string, string> tags = default, AzureLocation location = default, ContainerRegistryWebhookStatus? status = default, string scope = default, IEnumerable<ContainerRegistryWebhookAction> actions = default, ContainerRegistryProvisioningState? provisioningState = default)
        {
            ...
            return new ContainerRegistryWebhookData(
                ...
                tags,
                location,
                status is null && scope is null && provisioningState is null ? default : new WebhookProperties(status, scope, (actions ?? new ChangeTrackingList<ContainerRegistryWebhookAction>()).ToList(), provisioningState, null));
        }
        ...
        public static ContainerRegistryWebhookPatch ContainerRegistryWebhookPatch(IDictionary<string, string> tags = default, Uri serviceUri = default, IDictionary<string, string> customHeaders = default, ContainerRegistryWebhookStatus? status = default, string scope = default, IEnumerable<ContainerRegistryWebhookAction> actions = default)
        {
            ...
            return new ContainerRegistryWebhookPatch(tags, serviceUri is null && status is null && scope is null ? default : new WebhookPropertiesUpdateParameters(
                serviceUri,
                customHeaders,
                status,
                scope,
