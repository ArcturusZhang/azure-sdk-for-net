...
namespace Azure.ResourceManager.Resources
{
    ...
    public partial class TemplateSpecVersion : ArmResource
    {
        ...
        internal TemplateSpecVersion(ArmResource options, TemplateSpecVersionData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        internal TemplateSpecVersion(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            ClientOptions.TryGetApiVersion(ResourceType, out string apiVersion);
            _templateSpecVersionsRestClient = new TemplateSpecVersionsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal TemplateSpecVersion(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            ClientOptions.TryGetApiVersion(ResourceType, out string apiVersion);
            _templateSpecVersionsRestClient = new TemplateSpecVersionsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TemplateSpecVersion.Get");
            scope.Start();
            try
            {
                var response = await _templateSpecVersionsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<TemplateSpecVersion> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _templateSpecVersionsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TemplateSpecVersion.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TemplateSpecVersion.Delete");
            scope.Start();
            try
            {
                var response = await _templateSpecVersionsRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual TemplateSpecVersionDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _templateSpecVersionsRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new TemplateSpecVersionDeleteOperation(response);
                if (waitForCompletion)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<Response<TemplateSpecVersion>> UpdateAsync(TemplateSpecVersionUpdateModel templateSpecVersionUpdateModel = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("TemplateSpecVersion.Update");
            scope.Start();
            try
            {
                var response = await _templateSpecVersionsRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, templateSpecVersionUpdateModel, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new TemplateSpecVersion(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="templateSpecVersionUpdateModel"> Template Spec Version resource with the tags to be updated. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<TemplateSpecVersion> Update(TemplateSpecVersionUpdateModel templateSpecVersionUpdateModel = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("TemplateSpecVersion.Update");
            scope.Start();
            try
            {
                var response = _templateSpecVersionsRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, templateSpecVersionUpdateModel, cancellationToken);
                return Response.FromValue(new TemplateSpecVersion(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
