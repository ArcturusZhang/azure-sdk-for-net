...
namespace Azure.Provisioning.PostgreSql
{
    ...
    public partial class PostgreSqlFlexibleServersPrivateLinkResource : ProvisionableResource
    {
        ...
        internal PostgreSqlFlexibleServersPrivateLinkResource(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.DBforPostgreSQL/flexibleServers/privateLinkResources", resourceVersion ?? "2025-08-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for PostgreSqlFlexibleServersPrivateLinkResource. </summary>
        ...
        /// <summary> Creates a reference to an existing PostgreSqlFlexibleServersPrivateLinkResource. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static PostgreSqlFlexibleServersPrivateLinkResource FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            PostgreSqlFlexibleServersPrivateLinkResource result = new PostgreSqlFlexibleServersPrivateLinkResource(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for PostgreSqlFlexibleServersPrivateLinkResource that are not part of the generated code. </summary>
