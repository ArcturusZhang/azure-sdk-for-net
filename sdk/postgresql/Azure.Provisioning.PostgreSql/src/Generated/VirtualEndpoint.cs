...
namespace Azure.Provisioning.PostgreSql
{
    ...
    public partial class VirtualEndpoint : ProvisionableResource
    {
        ...
        internal VirtualEndpointResourceProperties Properties
        {
            get
            {
                Initialize();
        ...
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<VirtualEndpointResourceProperties>(nameof(Properties), new string[] { "properties" });
