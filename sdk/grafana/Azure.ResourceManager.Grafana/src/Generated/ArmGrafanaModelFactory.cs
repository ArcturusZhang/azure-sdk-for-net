    ...
    public static partial class ArmGrafanaModelFactory
    {
        ...
        public static ManagedGrafanaProperties ManagedGrafanaProperties(GrafanaProvisioningState? provisioningState = default, string grafanaVersion = default, string endpoint = default, GrafanaPublicNetworkAccess? publicNetworkAccess = default, GrafanaZoneRedundancy? zoneRedundancy = default, GrafanaApiKey? apiKey = default, GrafanaCreatorCanAdmin? creatorCanAdmin = default, DeterministicOutboundIP? deterministicOutboundIP = default, IEnumerable<string> outboundIPs = default, IEnumerable<GrafanaPrivateEndpointConnectionData> privateEndpointConnections = default, AutoGeneratedDomainNameLabelScope? autoGeneratedDomainNameLabelScope = default, IEnumerable<MonitorWorkspaceIntegration> monitorWorkspaceIntegrations = default, EnterpriseConfigurations enterpriseConfigurations = default, GrafanaConfigurations grafanaConfigurations = default, IDictionary<string, GrafanaPlugin> grafanaPlugins = default, string grafanaMajorVersion = default)
        {
            ...
            return new ManagedGrafanaProperties(
                ...
                autoGeneratedDomainNameLabelScope,
                new GrafanaIntegrations((monitorWorkspaceIntegrations ?? new ChangeTrackingList<MonitorWorkspaceIntegration>()).ToList(), null),
        ...
        public static GrafanaPrivateEndpointConnectionData GrafanaPrivateEndpointConnectionData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, GrafanaPrivateLinkServiceConnectionState connectionState = default, IEnumerable<string> groupIds = default, GrafanaPrivateEndpointConnectionProvisioningState? provisioningState = default, ResourceIdentifier privateEndpointId = default)
        {
            return new GrafanaPrivateEndpointConnectionData(
                ...
                systemData,
                additionalBinaryDataProperties: null,
                provisioningState is null && privateEndpointId is null ? default : new PrivateEndpointConnectionProperties(new PrivateEndpoint(privateEndpointId, null), connectionState, (groupIds ?? new ChangeTrackingList<string>()).ToList(), provisioningState, null));
        }
        ...
        public static GrafanaPrivateLinkResourceData GrafanaPrivateLinkResourceData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, GrafanaProvisioningState? provisioningState = default, string groupId = default, IEnumerable<string> requiredMembers = default, IEnumerable<string> requiredZoneNames = default)
        {
            return new GrafanaPrivateLinkResourceData(
                ...
                systemData,
                additionalBinaryDataProperties: null,
                provisioningState is null && groupId is null ? default : new GrafanaPrivateLinkResourceProperties(provisioningState, groupId, (requiredMembers ?? new ChangeTrackingList<string>()).ToList(), (requiredZoneNames ?? new ChangeTrackingList<string>()).ToList(), null));
        }
        ...
        public static ManagedPrivateEndpointModelData ManagedPrivateEndpointModelData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, IDictionary<string, string> tags = default, AzureLocation location = default, GrafanaProvisioningState? provisioningState = default, ResourceIdentifier privateLinkResourceId = default, string privateLinkResourceRegion = default, IEnumerable<string> groupIds = default, string requestMessage = default, ManagedPrivateEndpointConnectionState connectionState = default, Uri privateLinkServiceUri = default, string privateLinkServicePrivateIP = default)
        {
            ...
            return new ManagedPrivateEndpointModelData(
                ...
                tags,
                location,
                provisioningState is null && privateLinkResourceId is null && privateLinkResourceRegion is null && requestMessage is null && connectionState is null && privateLinkServiceUri is null && privateLinkServicePrivateIP is null ? default : new ManagedPrivateEndpointModelProperties(
                    provisioningState,
        ...
        public static GrafanaIntegrationFabricPatch GrafanaIntegrationFabricPatch(IDictionary<string, string> tags = default, IEnumerable<string> integrationFabricPropertiesUpdateParametersScenarios = default)
        {
            ...
            return new GrafanaIntegrationFabricPatch(tags, new IntegrationFabricPropertiesUpdateParameters((integrationFabricPropertiesUpdateParametersScenarios ?? new ChangeTrackingList<string>()).ToList(), null), additionalBinaryDataProperties: null);
        }
