...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class MongoDBDatabase : ArmResource
    {
        ...
        internal MongoDBDatabase(ArmResource options, MongoDBDatabaseData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("MongoDBDatabase.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<MongoDBDatabaseDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MongoDBDatabaseDeleteOperation(_clientDiagnostics, Pipeline, _mongoDBResourcesRestClient.CreateDeleteMongoDBDatabaseRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
