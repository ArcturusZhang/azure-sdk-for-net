...
require: C:\Users\dapzhang\Documents\workspace\azure-rest-api-specs\specification\network\resource-manager\readme.md
...
# virtualWan.json
  ...
  - from: swagger-document
    ...
    reason: Original 'operationId' doesn't follow pattern
  - remove-operation: "PublicIPAddresses_ListCloudServicePublicIPAddresses"
  - remove-operation: "PublicIPAddresses_ListCloudServiceRoleInstancePublicIPAddresses"
  - remove-operation: "PublicIPAddresses_GetCloudServicePublicIPAddress"
  - remove-operation: "PublicIPAddresses_ListVirtualMachineScaleSetPublicIPAddresses"
  - remove-operation: "PublicIPAddresses_ListVirtualMachineScaleSetVMPublicIPAddresses"
  - remove-operation: "PublicIPAddresses_GetVirtualMachineScaleSetPublicIPAddress"
  - remove-operation: "NetworkInterfaces_ListCloudServiceRoleInstanceNetworkInterfaces"
  - remove-operation: "NetworkInterfaces_ListCloudServiceNetworkInterfaces"
  - remove-operation: "NetworkInterfaces_GetCloudServiceNetworkInterface"
  - remove-operation: "NetworkInterfaces_ListVirtualMachineScaleSetVMNetworkInterfaces"
  - remove-operation: "NetworkInterfaces_ListVirtualMachineScaleSetNetworkInterfaces"
  - remove-operation: "NetworkInterfaces_GetVirtualMachineScaleSetNetworkInterface"
  - remove-operation: "NetworkInterfaces_ListVirtualMachineScaleSetIpConfigurations"
  - remove-operation: "NetworkInterfaces_GetVirtualMachineScaleSetIpConfiguration"
#   # this will make the generated code try to assign the tags to the corresponding resource data, which leads to compile error. Nevertheless we will generate functions to manipulate the tags, this method is redundant.
#   - remove-operation: "DdosProtectionPlans_CreateOrUpdate"
#   - remove-operation: "DdosProtectionPlans_Get"
