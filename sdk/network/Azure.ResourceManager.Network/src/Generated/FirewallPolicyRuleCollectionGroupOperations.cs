...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class FirewallPolicyRuleCollectionGroupOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, FirewallPolicyRuleCollectionGroup>
    {
        ...
        protected internal FirewallPolicyRuleCollectionGroupOperations(OperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
        ...
        /// <inheritdoc />
        public async override Task<Response<FirewallPolicyRuleCollectionGroup>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <inheritdoc />
        public override Response<FirewallPolicyRuleCollectionGroup> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("FirewallPolicyRuleCollectionGroupOperations.Get");
            scope.Start();
            try
