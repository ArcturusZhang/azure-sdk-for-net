...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NetworkProfileContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, NetworkProfile, NetworkProfileData>
    {
        ...
        internal NetworkProfileContainer(OperationsBase parent) : base(parent)
        {
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool DoesExist(string networkProfileName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("NetworkProfileContainer.DoesExist");
            scope.Start();
            try
            {
                if (networkProfileName == null)
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> DoesExistAsync(string networkProfileName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("NetworkProfileContainer.DoesExist");
            scope.Start();
            try
        ...
        public Pageable<NetworkProfile> List(CancellationToken cancellationToken = default)
        {
            Page<NetworkProfile> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("NetworkProfileContainer.List");
                scope.Start();
                try
                {
        ...
        public AsyncPageable<NetworkProfile> ListAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("NetworkProfileContainer.ListAsGenericResource");
            scope.Start();
            try
            {
        ...
        // Builders.
        // public ArmBuilder<ResourceGroupResourceIdentifier, NetworkProfile, NetworkProfileData> Construct() { }
    }
}
