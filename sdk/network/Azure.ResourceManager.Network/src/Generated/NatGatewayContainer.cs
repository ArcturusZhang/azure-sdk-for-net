...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class NatGatewayContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, NatGateway, NatGatewayData>
    {
        ...
        internal NatGatewayContainer(OperationsBase parent) : base(parent)
        {
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual NatGateway TryGet(string natGatewayName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("NatGatewayContainer.TryGet");
            scope.Start();
            try
            {
                if (natGatewayName == null)
                ...
                return Get(natGatewayName, expand, cancellationToken: cancellationToken).Value;
            }
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<NatGateway> TryGetAsync(string natGatewayName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("NatGatewayContainer.TryGet");
            scope.Start();
            try
            {
                ...
                return await GetAsync(natGatewayName, expand, cancellationToken: cancellationToken).ConfigureAwait(false);
            }
            catch (RequestFailedException e) when (e.Status == 404)
            {
                return null;
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool DoesExist(string natGatewayName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("NatGatewayContainer.DoesExist");
            scope.Start();
            try
            {
                if (natGatewayName == null)
                ...
                return TryGet(natGatewayName, expand, cancellationToken: cancellationToken) != null;
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> DoesExistAsync(string natGatewayName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("NatGatewayContainer.DoesExist");
            scope.Start();
            try
            {
                ...
                return await TryGetAsync(natGatewayName, expand, cancellationToken: cancellationToken).ConfigureAwait(false) != null;
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public Pageable<NatGateway> List(CancellationToken cancellationToken = default)
        {
            Page<NatGateway> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("NatGatewayContainer.List");
                scope.Start();
                try
                {
        ...
        public AsyncPageable<NatGateway> ListAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("NatGatewayContainer.ListAsGenericResource");
            scope.Start();
            try
            {
        ...
        // Builders.
        // public ArmBuilder<ResourceGroupResourceIdentifier, NatGateway, NatGatewayData> Construct() { }
    }
}
