...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnGatewayOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, VpnGateway>
    {
        ...
        protected internal VpnGatewayOperations(OperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
