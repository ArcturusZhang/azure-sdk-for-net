...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualHubRouteTableV2Container : ResourceContainerBase<ResourceGroupResourceIdentifier, VirtualHubRouteTableV2, VirtualHubRouteTableV2Data>
    {
        ...
        internal VirtualHubRouteTableV2Container(OperationsBase parent) : base(parent)
        {
        ...
        /// <param name="routeTableName"> The name of the VirtualHubRouteTableV2. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual VirtualHubRouteTableV2 TryGet(string routeTableName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualHubRouteTableV2Container.TryGet");
            scope.Start();
            try
            {
                if (routeTableName == null)
        ...
        /// <param name="routeTableName"> The name of the VirtualHubRouteTableV2. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<VirtualHubRouteTableV2> TryGetAsync(string routeTableName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualHubRouteTableV2Container.TryGet");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualHubRouteTableV2Container.DoesExist");
            scope.Start();
            try
            {
                if (routeTableName == null)
        ...
        public Pageable<VirtualHubRouteTableV2> List(CancellationToken cancellationToken = default)
        {
            Page<VirtualHubRouteTableV2> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("VirtualHubRouteTableV2Container.List");
                scope.Start();
                try
                {
        ...
        public AsyncPageable<VirtualHubRouteTableV2> ListAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualHubRouteTableV2Container.ListAsGenericResource");
            scope.Start();
            try
            {
        ...
        // Builders.
        // public ArmBuilder<ResourceGroupResourceIdentifier, VirtualHubRouteTableV2, VirtualHubRouteTableV2Data> Construct() { }
    }
}
