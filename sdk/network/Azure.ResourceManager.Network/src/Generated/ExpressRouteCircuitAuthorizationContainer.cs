...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ExpressRouteCircuitAuthorizationContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, ExpressRouteCircuitAuthorization, ExpressRouteCircuitAuthorizationData>
    {
        ...
        internal ExpressRouteCircuitAuthorizationContainer(OperationsBase parent) : base(parent)
        {
        ...
        /// <param name="authorizationName"> The name of the authorization. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool DoesExist(string authorizationName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteCircuitAuthorizationContainer.DoesExist");
            scope.Start();
            try
            {
                if (authorizationName == null)
        ...
        /// <param name="authorizationName"> The name of the authorization. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> DoesExistAsync(string authorizationName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteCircuitAuthorizationContainer.DoesExist");
            scope.Start();
            try
        ...
        public Pageable<ExpressRouteCircuitAuthorization> List(CancellationToken cancellationToken = default)
        {
            Page<ExpressRouteCircuitAuthorization> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("ExpressRouteCircuitAuthorizationContainer.List");
                scope.Start();
                try
                {
        ...
        public AsyncPageable<ExpressRouteCircuitAuthorization> ListAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ExpressRouteCircuitAuthorizationContainer.ListAsGenericResource");
            scope.Start();
            try
            {
