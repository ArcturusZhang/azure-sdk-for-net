...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class IpAllocationContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, IpAllocation, IpAllocationData>
    {
        ...
        internal IpAllocationContainer(OperationsBase parent) : base(parent)
        {
        ...
        public virtual Response<IpAllocation> CreateOrUpdate(string ipAllocationName, IpAllocationData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var operation = StartCreateOrUpdate(ipAllocationName, parameters, cancellationToken);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ipAllocationName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<Response<IpAllocation>> CreateOrUpdateAsync(string ipAllocationName, IpAllocationData parameters, CancellationToken cancellationToken = default)
        {
            if (ipAllocationName == null)
            {
                throw new ArgumentNullException(nameof(ipAllocationName));
            ...
            try
            {
                var operation = await StartCreateOrUpdateAsync(ipAllocationName, parameters, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ipAllocationName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual IpAllocationsCreateOrUpdateOperation StartCreateOrUpdate(string ipAllocationName, IpAllocationData parameters, CancellationToken cancellationToken = default)
        {
            if (ipAllocationName == null)
            {
                throw new ArgumentNullException(nameof(ipAllocationName));
            ...
            using var scope = _clientDiagnostics.CreateScope("IpAllocationContainer.StartCreateOrUpdate");
            scope.Start();
            try
            {
                var response = _restClient.CreateOrUpdate(Id.ResourceGroupName, ipAllocationName, parameters, cancellationToken);
                return new IpAllocationsCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, ipAllocationName, parameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ipAllocationName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<IpAllocationsCreateOrUpdateOperation> StartCreateOrUpdateAsync(string ipAllocationName, IpAllocationData parameters, CancellationToken cancellationToken = default)
        {
            if (ipAllocationName == null)
            {
                throw new ArgumentNullException(nameof(ipAllocationName));
            ...
            try
            {
                var response = await _restClient.CreateOrUpdateAsync(Id.ResourceGroupName, ipAllocationName, parameters, cancellationToken).ConfigureAwait(false);
                return new IpAllocationsCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, ipAllocationName, parameters).Request, response);
            }
            catch (Exception e)
            {
        ...
        public async virtual Task<Response<IpAllocation>> GetAsync(string ipAllocationName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var response = await _restClient.GetAsync(Id.ResourceGroupName, ipAllocationName, expand, cancellationToken: cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new IpAllocation(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual IpAllocation TryGet(string ipAllocationName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("IpAllocationContainer.TryGet");
            scope.Start();
            try
            {
                if (ipAllocationName == null)
                ...
                return Get(ipAllocationName, expand, cancellationToken: cancellationToken).Value;
            }
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<IpAllocation> TryGetAsync(string ipAllocationName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("IpAllocationContainer.TryGet");
            scope.Start();
            try
            {
                ...
                return await GetAsync(ipAllocationName, expand, cancellationToken: cancellationToken).ConfigureAwait(false);
            }
            catch (RequestFailedException e) when (e.Status == 404)
            {
                return null;
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool DoesExist(string ipAllocationName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("IpAllocationContainer.DoesExist");
            scope.Start();
            try
            {
                if (ipAllocationName == null)
                ...
                return TryGet(ipAllocationName, expand, cancellationToken: cancellationToken) != null;
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> DoesExistAsync(string ipAllocationName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("IpAllocationContainer.DoesExist");
            scope.Start();
            try
            {
                ...
                return await TryGetAsync(ipAllocationName, expand, cancellationToken: cancellationToken).ConfigureAwait(false) != null;
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public Pageable<IpAllocation> List(CancellationToken cancellationToken = default)
        {
        ...
        public AsyncPageable<IpAllocation> ListAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("IpAllocationContainer.ListAsGenericResource");
            scope.Start();
            try
            {
                var filters = new ResourceFilterCollection(IpAllocationOperations.ResourceType);
