...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VpnConnectionContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, VpnConnection, VpnConnectionData>
    {
        ...
        internal VpnConnectionContainer(OperationsBase parent) : base(parent)
        {
        ...
        public virtual Response<VpnConnection> CreateOrUpdate(string connectionName, VpnConnectionData vpnConnectionParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var operation = StartCreateOrUpdate(connectionName, vpnConnectionParameters, cancellationToken);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="connectionName"/> or <paramref name="vpnConnectionParameters"/> is null. </exception>
        public async virtual Task<Response<VpnConnection>> CreateOrUpdateAsync(string connectionName, VpnConnectionData vpnConnectionParameters, CancellationToken cancellationToken = default)
        {
            if (connectionName == null)
            {
                throw new ArgumentNullException(nameof(connectionName));
            ...
            try
            {
                var operation = await StartCreateOrUpdateAsync(connectionName, vpnConnectionParameters, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="connectionName"/> or <paramref name="vpnConnectionParameters"/> is null. </exception>
        public virtual VpnConnectionsCreateOrUpdateOperation StartCreateOrUpdate(string connectionName, VpnConnectionData vpnConnectionParameters, CancellationToken cancellationToken = default)
        {
            if (connectionName == null)
            {
                throw new ArgumentNullException(nameof(connectionName));
            ...
            using var scope = _clientDiagnostics.CreateScope("VpnConnectionContainer.StartCreateOrUpdate");
            scope.Start();
            try
            {
                ...
                return new VpnConnectionsCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, Id.Name, connectionName, vpnConnectionParameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="connectionName"/> or <paramref name="vpnConnectionParameters"/> is null. </exception>
        public async virtual Task<VpnConnectionsCreateOrUpdateOperation> StartCreateOrUpdateAsync(string connectionName, VpnConnectionData vpnConnectionParameters, CancellationToken cancellationToken = default)
        {
            if (connectionName == null)
            {
                throw new ArgumentNullException(nameof(connectionName));
        ...
        /// <param name="connectionName"> The name of the vpn connection. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual VpnConnection TryGet(string connectionName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VpnConnectionContainer.TryGet");
            scope.Start();
            try
            {
                if (connectionName == null)
        ...
        /// <param name="connectionName"> The name of the vpn connection. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<VpnConnection> TryGetAsync(string connectionName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VpnConnectionContainer.TryGet");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VpnConnectionContainer.DoesExist");
            scope.Start();
            try
            {
                if (connectionName == null)
        ...
        public Pageable<VpnConnection> List(CancellationToken cancellationToken = default)
        {
        ...
        public AsyncPageable<VpnConnection> ListAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Filters the list of <see cref="VpnConnection" /> for this resource group represented as generic resources. </summary>
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VpnConnectionContainer.ListAsGenericResource");
            scope.Start();
            try
            {
                var filters = new ResourceFilterCollection(VpnConnectionOperations.ResourceType);
