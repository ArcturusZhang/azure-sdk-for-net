...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PrivateLinkServiceContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, PrivateLinkService, PrivateLinkServiceData>
    {
        ...
        internal PrivateLinkServiceContainer(OperationsBase parent) : base(parent)
        {
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool DoesExist(string serviceName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PrivateLinkServiceContainer.DoesExist");
            scope.Start();
            try
            {
                if (serviceName == null)
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> DoesExistAsync(string serviceName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("PrivateLinkServiceContainer.DoesExist");
            scope.Start();
            try
        ...
        public Pageable<PrivateLinkService> List(CancellationToken cancellationToken = default)
        {
            Page<PrivateLinkService> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("PrivateLinkServiceContainer.List");
                scope.Start();
                try
                {
        ...
        public AsyncPageable<PrivateLinkService> ListAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("PrivateLinkServiceContainer.ListAsGenericResource");
            scope.Start();
            try
            {
