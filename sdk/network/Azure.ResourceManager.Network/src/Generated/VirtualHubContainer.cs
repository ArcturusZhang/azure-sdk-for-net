...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualHubContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, VirtualHub, VirtualHubData>
    {
        ...
        internal VirtualHubContainer(OperationsBase parent) : base(parent)
        {
        ...
        /// <param name="virtualHubName"> The name of the VirtualHub. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual VirtualHub TryGet(string virtualHubName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualHubContainer.TryGet");
            scope.Start();
            try
            {
                if (virtualHubName == null)
                ...
                return Get(virtualHubName, cancellationToken: cancellationToken).Value;
            }
        ...
        /// <param name="virtualHubName"> The name of the VirtualHub. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<VirtualHub> TryGetAsync(string virtualHubName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualHubContainer.TryGet");
            scope.Start();
            try
            {
                ...
                return await GetAsync(virtualHubName, cancellationToken: cancellationToken).ConfigureAwait(false);
            }
            catch (RequestFailedException e) when (e.Status == 404)
            {
                return null;
        ...
        /// <param name="virtualHubName"> The name of the VirtualHub. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool DoesExist(string virtualHubName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualHubContainer.DoesExist");
            scope.Start();
            try
            {
                if (virtualHubName == null)
                ...
                return TryGet(virtualHubName, cancellationToken: cancellationToken) != null;
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="virtualHubName"> The name of the VirtualHub. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> DoesExistAsync(string virtualHubName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualHubContainer.DoesExist");
            scope.Start();
            try
            {
                ...
                return await TryGetAsync(virtualHubName, cancellationToken: cancellationToken).ConfigureAwait(false) != null;
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public Pageable<VirtualHub> List(CancellationToken cancellationToken = default)
        {
            Page<VirtualHub> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("VirtualHubContainer.ListByResourceGroup");
                scope.Start();
                try
                {
        ...
        public AsyncPageable<VirtualHub> ListAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualHubContainer.ListAsGenericResource");
            scope.Start();
            try
            {
        ...
        // Builders.
        // public ArmBuilder<ResourceGroupResourceIdentifier, VirtualHub, VirtualHubData> Construct() { }
    }
}
