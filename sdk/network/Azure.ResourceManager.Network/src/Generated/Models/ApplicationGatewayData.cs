...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class ApplicationGatewayData : Resource
    {
        ...
        /// <param name="resourceIdentity"> The identity of the application gateway, if configured. </param>
