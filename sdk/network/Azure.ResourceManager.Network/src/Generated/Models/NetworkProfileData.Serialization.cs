...
namespace Azure.ResourceManager.Network.Models
{
    public partial class NetworkProfileData : IUtf8JsonSerializable
    {
        ...
        internal static NetworkProfileData DeserializeNetworkProfileData(JsonElement element)
        {
            ...
            return new NetworkProfileData(id, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), etag.Value, Optional.ToList(containerNetworkInterfaces), Optional.ToList(containerNetworkInterfaceConfigurations), resourceGuid.Value, Optional.ToNullable(provisioningState));
        }
    }
}
