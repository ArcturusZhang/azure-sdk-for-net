...
namespace Azure.ResourceManager.Network.Models
{
    public partial class ExpressRouteServiceProvider : IUtf8JsonSerializable
    {
        ...
        internal static ExpressRouteServiceProvider DeserializeExpressRouteServiceProvider(JsonElement element)
        {
            ...
            return new ExpressRouteServiceProvider(id, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), Optional.ToList(peeringLocations), Optional.ToList(bandwidthsOffered), Optional.ToNullable(provisioningState));
        }
    }
}
