...
namespace Azure.ResourceManager.Network.Models
{
    public partial class AzureFirewallFqdnTag : IUtf8JsonSerializable
    {
        ...
        internal static AzureFirewallFqdnTag DeserializeAzureFirewallFqdnTag(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("fqdnTagName"))
                        {
            ...
            return new AzureFirewallFqdnTag(id, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), etag.Value, Optional.ToNullable(provisioningState), fqdnTagName.Value);
        }
    }
}
