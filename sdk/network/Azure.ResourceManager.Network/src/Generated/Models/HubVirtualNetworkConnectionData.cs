...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class HubVirtualNetworkConnectionData : WritableSubResource<ResourceGroupResourceIdentifier>
    {
        ...
        internal HubVirtualNetworkConnectionData(string id, string name, string etag, SubResource remoteVirtualNetwork, bool? allowHubToRemoteVnetTransit, bool? allowRemoteVnetToUseHubVnetGateways, bool? enableInternetSecurity, RoutingConfiguration routingConfiguration, ProvisioningState? provisioningState) : base(id)
        {
            Name = name;
            Etag = etag;
