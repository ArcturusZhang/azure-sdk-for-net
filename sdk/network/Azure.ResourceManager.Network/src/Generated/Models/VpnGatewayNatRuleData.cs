...
namespace Azure.ResourceManager.Network.Models
{
    ...
    public partial class VpnGatewayNatRuleData : WritableSubResource<ResourceGroupResourceIdentifier>
    {
        ...
        internal VpnGatewayNatRuleData(string id, string name, string etag, string type, ProvisioningState? provisioningState, VpnNatRuleType? typePropertiesType, VpnNatRuleMode? mode, IList<VpnNatRuleMapping> internalMappings, IList<VpnNatRuleMapping> externalMappings, string ipConfigurationId, IReadOnlyList<SubResource> egressVpnSiteLinkConnections, IReadOnlyList<SubResource> ingressVpnSiteLinkConnections) : base(id)
        {
            Name = name;
            Etag = etag;
            Type = type;
        ...
        public IReadOnlyList<SubResource> EgressVpnSiteLinkConnections { get; }
        /// <summary> List of ingress VpnSiteLinkConnections. </summary>
        public IReadOnlyList<SubResource> IngressVpnSiteLinkConnections { get; }
    }
}
