...
namespace Azure.ResourceManager.Network.Models
{
    public partial class IpGroupData : IUtf8JsonSerializable
    {
        ...
        internal static IpGroupData DeserializeIpGroupData(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<SubResource>> firewallPolicies = default;
            ...
            return new IpGroupData(id, name.Value, type.Value, location.Value, Optional.ToDictionary(tags), etag.Value, Optional.ToNullable(provisioningState), Optional.ToList(ipAddresses), Optional.ToList(firewalls), Optional.ToList(firewallPolicies));
        }
    }
}
