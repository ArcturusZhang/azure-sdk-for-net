...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class SecurityPartnerProviderOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, SecurityPartnerProvider>
    {
        ...
        protected internal SecurityPartnerProviderOperations(OperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
        ...
        /// <inheritdoc />
        public async override Task<Response<SecurityPartnerProvider>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <inheritdoc />
        public override Response<SecurityPartnerProvider> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SecurityPartnerProviderOperations.Get");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<SecurityPartnerProviderData>> UpdateTagsAsync(IDictionary<string, string> tags = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="tags"> Resource tags. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<SecurityPartnerProviderData> UpdateTags(IDictionary<string, string> tags = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SecurityPartnerProviderOperations.UpdateTags");
            scope.Start();
            try
