...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class SecurityPartnerProviderContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, SecurityPartnerProvider, SecurityPartnerProviderData>
    {
        ...
        internal SecurityPartnerProviderContainer(OperationsBase parent) : base(parent)
        {
        ...
        /// <param name="securityPartnerProviderName"> The name of the Security Partner Provider. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool DoesExist(string securityPartnerProviderName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SecurityPartnerProviderContainer.DoesExist");
            scope.Start();
            try
            {
                if (securityPartnerProviderName == null)
        ...
        /// <param name="securityPartnerProviderName"> The name of the Security Partner Provider. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> DoesExistAsync(string securityPartnerProviderName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SecurityPartnerProviderContainer.DoesExist");
            scope.Start();
            try
        ...
        public Pageable<SecurityPartnerProvider> List(CancellationToken cancellationToken = default)
        {
        ...
        public AsyncPageable<SecurityPartnerProvider> ListAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SecurityPartnerProviderContainer.ListAsGenericResource");
            scope.Start();
            try
            {
