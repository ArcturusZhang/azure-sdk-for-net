...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class BastionHostContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, BastionHost, BastionHostData>
    {
        ...
        /// <summary> Initializes a new instance of BastionHostContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal BastionHostContainer(OperationsBase parent) : base(parent)
        {
        ...
        public virtual Response<BastionHost> CreateOrUpdate(string bastionHostName, BastionHostData parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("BastionHostContainer.CreateOrUpdate");
            scope.Start();
            try
            {
                var operation = StartCreateOrUpdate(bastionHostName, parameters, cancellationToken);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="bastionHostName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<Response<BastionHost>> CreateOrUpdateAsync(string bastionHostName, BastionHostData parameters, CancellationToken cancellationToken = default)
        {
            if (bastionHostName == null)
            {
                throw new ArgumentNullException(nameof(bastionHostName));
            ...
            try
            {
                var operation = await StartCreateOrUpdateAsync(bastionHostName, parameters, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="bastionHostName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual BastionHostsCreateOrUpdateOperation StartCreateOrUpdate(string bastionHostName, BastionHostData parameters, CancellationToken cancellationToken = default)
        {
            if (bastionHostName == null)
            {
                throw new ArgumentNullException(nameof(bastionHostName));
            ...
            using var scope = _clientDiagnostics.CreateScope("BastionHostContainer.StartCreateOrUpdate");
            scope.Start();
            try
            {
                var response = _restClient.CreateOrUpdate(Id.ResourceGroupName, bastionHostName, parameters, cancellationToken);
                return new BastionHostsCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, bastionHostName, parameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="bastionHostName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<BastionHostsCreateOrUpdateOperation> StartCreateOrUpdateAsync(string bastionHostName, BastionHostData parameters, CancellationToken cancellationToken = default)
        {
            if (bastionHostName == null)
            {
                throw new ArgumentNullException(nameof(bastionHostName));
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("BastionHostContainer.Get");
            scope.Start();
            try
            {
                if (bastionHostName == null)
        ...
        /// <param name="bastionHostName"> The name of the Bastion Host. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<BastionHost> TryGetAsync(string bastionHostName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("BastionHostContainer.TryGet");
            scope.Start();
            try
        ...
        /// <param name="bastionHostName"> The name of the Bastion Host. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool DoesExist(string bastionHostName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("BastionHostContainer.DoesExist");
            scope.Start();
            try
            {
                if (bastionHostName == null)
        ...
        /// <param name="bastionHostName"> The name of the Bastion Host. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> DoesExistAsync(string bastionHostName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("BastionHostContainer.DoesExist");
            scope.Start();
            try
        ...
        public Pageable<BastionHost> List(CancellationToken cancellationToken = default)
        {
        ...
        public AsyncPageable<BastionHost> ListAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("BastionHostContainer.ListAsGenericResource");
            scope.Start();
            try
            {
                var filters = new ResourceFilterCollection(BastionHostOperations.ResourceType);
