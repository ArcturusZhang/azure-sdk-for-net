...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class FlowLogContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, FlowLog, FlowLogData>
    {
        ...
        internal FlowLogContainer(OperationsBase parent) : base(parent)
        {
        ...
        /// <param name="flowLogName"> The name of the flow log resource. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool DoesExist(string flowLogName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("FlowLogContainer.DoesExist");
            scope.Start();
            try
            {
                if (flowLogName == null)
        ...
        /// <param name="flowLogName"> The name of the flow log resource. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> DoesExistAsync(string flowLogName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("FlowLogContainer.DoesExist");
            scope.Start();
            try
        ...
        public Pageable<FlowLog> List(CancellationToken cancellationToken = default)
        {
            Page<FlowLog> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("FlowLogContainer.List");
                scope.Start();
                try
                {
        ...
        public AsyncPageable<FlowLog> ListAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("FlowLogContainer.ListAsGenericResource");
            scope.Start();
            try
            {
        ...
        // Builders.
        // public ArmBuilder<ResourceGroupResourceIdentifier, FlowLog, FlowLogData> Construct() { }
    }
}
