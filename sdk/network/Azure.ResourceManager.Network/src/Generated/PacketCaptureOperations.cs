...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PacketCaptureOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, PacketCapture>
    {
        ...
        protected internal PacketCaptureOperations(OperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
