...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class BackendAddressPoolContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, BackendAddressPool, BackendAddressPoolData>
    {
        ...
        internal BackendAddressPoolContainer(OperationsBase parent) : base(parent)
        {
        ...
        /// <param name="backendAddressPoolName"> The name of the backend address pool. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool DoesExist(string backendAddressPoolName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("BackendAddressPoolContainer.DoesExist");
            scope.Start();
            try
            {
                if (backendAddressPoolName == null)
        ...
        /// <param name="backendAddressPoolName"> The name of the backend address pool. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> DoesExistAsync(string backendAddressPoolName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("BackendAddressPoolContainer.DoesExist");
            scope.Start();
            try
        ...
        public Pageable<BackendAddressPool> List(CancellationToken cancellationToken = default)
        {
            Page<BackendAddressPool> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("BackendAddressPoolContainer.List");
                scope.Start();
                try
                {
        ...
        public AsyncPageable<BackendAddressPool> ListAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("BackendAddressPoolContainer.ListAsGenericResource");
            scope.Start();
            try
            {
        ...
        // Builders.
        // public ArmBuilder<ResourceGroupResourceIdentifier, BackendAddressPool, BackendAddressPoolData> Construct() { }
    }
}
