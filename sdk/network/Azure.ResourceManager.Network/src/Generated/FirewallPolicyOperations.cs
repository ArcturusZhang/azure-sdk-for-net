...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class FirewallPolicyOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, FirewallPolicy>
    {
        ...
        protected internal FirewallPolicyOperations(OperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
        ...
        /// <inheritdoc />
        public async override Task<Response<FirewallPolicy>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <inheritdoc />
        public override Response<FirewallPolicy> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("FirewallPolicyOperations.Get");
            scope.Start();
            try
        ...
        public async virtual Task<Response<FirewallPolicy>> GetAsync(string expand, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("FirewallPolicyOperations.Get");
            scope.Start();
            try
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<FirewallPolicy> Get(string expand, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("FirewallPolicyOperations.Get");
            scope.Start();
            try
