...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualNetworkGatewayContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, VirtualNetworkGateway, VirtualNetworkGatewayData>
    {
        ...
        internal VirtualNetworkGatewayContainer(OperationsBase parent) : base(parent)
        {
        ...
        /// <param name="virtualNetworkGatewayName"> The name of the virtual network gateway. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual VirtualNetworkGateway TryGet(string virtualNetworkGatewayName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualNetworkGatewayContainer.TryGet");
            scope.Start();
            try
            {
                if (virtualNetworkGatewayName == null)
                ...
                return Get(virtualNetworkGatewayName, cancellationToken: cancellationToken).Value;
            }
        ...
        /// <param name="virtualNetworkGatewayName"> The name of the virtual network gateway. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<VirtualNetworkGateway> TryGetAsync(string virtualNetworkGatewayName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualNetworkGatewayContainer.TryGet");
            scope.Start();
            try
            {
                ...
                return await GetAsync(virtualNetworkGatewayName, cancellationToken: cancellationToken).ConfigureAwait(false);
            }
            catch (RequestFailedException e) when (e.Status == 404)
            {
                return null;
        ...
        /// <param name="virtualNetworkGatewayName"> The name of the virtual network gateway. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool DoesExist(string virtualNetworkGatewayName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualNetworkGatewayContainer.DoesExist");
            scope.Start();
            try
            {
                if (virtualNetworkGatewayName == null)
                ...
                return TryGet(virtualNetworkGatewayName, cancellationToken: cancellationToken) != null;
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="virtualNetworkGatewayName"> The name of the virtual network gateway. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> DoesExistAsync(string virtualNetworkGatewayName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualNetworkGatewayContainer.DoesExist");
            scope.Start();
            try
            {
                ...
                return await TryGetAsync(virtualNetworkGatewayName, cancellationToken: cancellationToken).ConfigureAwait(false) != null;
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public Pageable<VirtualNetworkGateway> List(CancellationToken cancellationToken = default)
        {
            Page<VirtualNetworkGateway> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("VirtualNetworkGatewayContainer.List");
                scope.Start();
                try
                {
        ...
        public AsyncPageable<VirtualNetworkGateway> ListAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualNetworkGatewayContainer.ListAsGenericResource");
            scope.Start();
            try
            {
        ...
        // Builders.
        // public ArmBuilder<ResourceGroupResourceIdentifier, VirtualNetworkGateway, VirtualNetworkGatewayData> Construct() { }
    }
}
