...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class VirtualNetworkGatewayConnectionContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, VirtualNetworkGatewayConnection, VirtualNetworkGatewayConnectionData>
    {
        ...
        internal VirtualNetworkGatewayConnectionContainer(OperationsBase parent) : base(parent)
        {
        ...
        private VirtualNetworkGatewayConnectionsRestOperations _restClient => new VirtualNetworkGatewayConnectionsRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="virtualNetworkGatewayConnectionName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual VirtualNetworkGatewayConnectionsCreateOrUpdateOperation StartCreateOrUpdate(string virtualNetworkGatewayConnectionName, VirtualNetworkGatewayConnectionData parameters, CancellationToken cancellationToken = default)
        {
            if (virtualNetworkGatewayConnectionName == null)
            {
                throw new ArgumentNullException(nameof(virtualNetworkGatewayConnectionName));
            ...
            try
            {
                ...
                return new VirtualNetworkGatewayConnectionsCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, virtualNetworkGatewayConnectionName, parameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="virtualNetworkGatewayConnectionName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<VirtualNetworkGatewayConnectionsCreateOrUpdateOperation> StartCreateOrUpdateAsync(string virtualNetworkGatewayConnectionName, VirtualNetworkGatewayConnectionData parameters, CancellationToken cancellationToken = default)
        {
            if (virtualNetworkGatewayConnectionName == null)
            {
                throw new ArgumentNullException(nameof(virtualNetworkGatewayConnectionName));
        ...
        /// <param name="virtualNetworkGatewayConnectionName"> The name of the virtual network gateway connection. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool DoesExist(string virtualNetworkGatewayConnectionName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualNetworkGatewayConnectionContainer.DoesExist");
            scope.Start();
            try
            {
                if (virtualNetworkGatewayConnectionName == null)
        ...
        /// <param name="virtualNetworkGatewayConnectionName"> The name of the virtual network gateway connection. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> DoesExistAsync(string virtualNetworkGatewayConnectionName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualNetworkGatewayConnectionContainer.DoesExist");
            scope.Start();
            try
        ...
        public Pageable<VirtualNetworkGatewayConnection> List(CancellationToken cancellationToken = default)
        {
            Page<VirtualNetworkGatewayConnection> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("VirtualNetworkGatewayConnectionContainer.List");
                scope.Start();
                try
                {
        ...
        public AsyncPageable<VirtualNetworkGatewayConnection> ListAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualNetworkGatewayConnectionContainer.ListAsGenericResource");
            scope.Start();
            try
            {
                var filters = new ResourceFilterCollection(VirtualNetworkGatewayConnectionOperations.ResourceType);
        ...
        // Builders.
        // public ArmBuilder<ResourceGroupResourceIdentifier, VirtualNetworkGatewayConnection, VirtualNetworkGatewayConnectionData> Construct() { }
    }
}
