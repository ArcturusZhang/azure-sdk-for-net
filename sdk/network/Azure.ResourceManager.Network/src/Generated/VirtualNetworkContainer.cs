...
{
    /// <summary> A class representing collection of VirtualNetwork and their operations over a ResourceGroup. </summary>
    public partial class VirtualNetworkContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, VirtualNetwork, VirtualNetworkData>
    {
        /// <summary> Initializes a new instance of the <see cref="VirtualNetworkContainer"/> class for mocking. </summary>
        protected VirtualNetworkContainer()
        {
        }

        /// <summary> Initializes a new instance of VirtualNetworkContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal VirtualNetworkContainer(OperationsBase parent) : base(parent)
        {
        ...
        private VirtualNetworksRestOperations _restClient => new VirtualNetworksRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        ...
        public virtual Response<VirtualNetwork> CreateOrUpdate(string virtualNetworkName, VirtualNetworkData parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualNetworkContainer.CreateOrUpdate");
            scope.Start();
            try
            {
                var operation = StartCreateOrUpdate(virtualNetworkName, parameters, cancellationToken);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="virtualNetworkName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<Response<VirtualNetwork>> CreateOrUpdateAsync(string virtualNetworkName, VirtualNetworkData parameters, CancellationToken cancellationToken = default)
        {
            if (virtualNetworkName == null)
            {
                throw new ArgumentNullException(nameof(virtualNetworkName));
            ...
            try
            {
                var operation = await StartCreateOrUpdateAsync(virtualNetworkName, parameters, cancellationToken).ConfigureAwait(false);
        ...
        public virtual VirtualNetworksCreateOrUpdateOperation StartCreateOrUpdate(string virtualNetworkName, VirtualNetworkData parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("VirtualNetworkContainer.StartCreateOrUpdate");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualNetworkContainer.Get");
            scope.Start();
            try
            {
                if (virtualNetworkName == null)
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool DoesExist(string virtualNetworkName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualNetworkContainer.DoesExist");
            scope.Start();
            try
            {
                if (virtualNetworkName == null)
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> DoesExistAsync(string virtualNetworkName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualNetworkContainer.DoesExist");
            scope.Start();
            try
        ...
        public Pageable<VirtualNetwork> List(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("VirtualNetworkContainer.List");
                scope.Start();
                try
                {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("VirtualNetworkContainer.ListAsGenericResource");
            scope.Start();
            try
            {
                var filters = new ResourceFilterCollection(VirtualNetworkOperations.ResourceType);
        ...
        // Builders.
        // public ArmBuilder<ResourceGroupResourceIdentifier, VirtualNetwork, VirtualNetworkData> Construct() { }
    }
}
