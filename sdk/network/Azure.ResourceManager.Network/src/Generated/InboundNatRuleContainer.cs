...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class InboundNatRuleContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, InboundNatRule, InboundNatRuleData>
    {
        ...
        /// <summary> Initializes a new instance of InboundNatRuleContainer class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal InboundNatRuleContainer(OperationsBase parent) : base(parent)
        {
        ...
        public virtual Response<InboundNatRule> CreateOrUpdate(string inboundNatRuleName, InboundNatRuleData inboundNatRuleParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var operation = StartCreateOrUpdate(inboundNatRuleName, inboundNatRuleParameters, cancellationToken);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="inboundNatRuleName"/> or <paramref name="inboundNatRuleParameters"/> is null. </exception>
        public async virtual Task<Response<InboundNatRule>> CreateOrUpdateAsync(string inboundNatRuleName, InboundNatRuleData inboundNatRuleParameters, CancellationToken cancellationToken = default)
        {
            if (inboundNatRuleName == null)
            {
                throw new ArgumentNullException(nameof(inboundNatRuleName));
            ...
            try
            {
                var operation = await StartCreateOrUpdateAsync(inboundNatRuleName, inboundNatRuleParameters, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="inboundNatRuleName"/> or <paramref name="inboundNatRuleParameters"/> is null. </exception>
        public virtual InboundNatRulesCreateOrUpdateOperation StartCreateOrUpdate(string inboundNatRuleName, InboundNatRuleData inboundNatRuleParameters, CancellationToken cancellationToken = default)
        {
            if (inboundNatRuleName == null)
            {
                throw new ArgumentNullException(nameof(inboundNatRuleName));
            ...
            using var scope = _clientDiagnostics.CreateScope("InboundNatRuleContainer.StartCreateOrUpdate");
            scope.Start();
            try
            {
                var response = _restClient.CreateOrUpdate(Id.ResourceGroupName, Id.Name, inboundNatRuleName, inboundNatRuleParameters, cancellationToken);
                return new InboundNatRulesCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, Id.Name, inboundNatRuleName, inboundNatRuleParameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="inboundNatRuleName"/> or <paramref name="inboundNatRuleParameters"/> is null. </exception>
        public async virtual Task<InboundNatRulesCreateOrUpdateOperation> StartCreateOrUpdateAsync(string inboundNatRuleName, InboundNatRuleData inboundNatRuleParameters, CancellationToken cancellationToken = default)
        {
            if (inboundNatRuleName == null)
            {
                throw new ArgumentNullException(nameof(inboundNatRuleName));
        ...
        public virtual Response<InboundNatRule> Get(string inboundNatRuleName, string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var response = _restClient.Get(Id.ResourceGroupName, Id.Name, inboundNatRuleName, expand, cancellationToken: cancellationToken);
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual InboundNatRule TryGet(string inboundNatRuleName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("InboundNatRuleContainer.TryGet");
            scope.Start();
            try
            {
                if (inboundNatRuleName == null)
                ...
                return Get(inboundNatRuleName, expand, cancellationToken: cancellationToken).Value;
            }
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<InboundNatRule> TryGetAsync(string inboundNatRuleName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("InboundNatRuleContainer.TryGet");
            scope.Start();
            try
            {
                ...
                return await GetAsync(inboundNatRuleName, expand, cancellationToken: cancellationToken).ConfigureAwait(false);
            }
            catch (RequestFailedException e) when (e.Status == 404)
            {
                return null;
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool DoesExist(string inboundNatRuleName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("InboundNatRuleContainer.DoesExist");
            scope.Start();
            try
            {
                if (inboundNatRuleName == null)
                ...
                return TryGet(inboundNatRuleName, expand, cancellationToken: cancellationToken) != null;
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="expand"> Expands referenced resources. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> DoesExistAsync(string inboundNatRuleName, string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("InboundNatRuleContainer.DoesExist");
            scope.Start();
            try
            {
                ...
                return await TryGetAsync(inboundNatRuleName, expand, cancellationToken: cancellationToken).ConfigureAwait(false) != null;
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public Pageable<InboundNatRule> List(CancellationToken cancellationToken = default)
        {
            Page<InboundNatRule> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("InboundNatRuleContainer.List");
                scope.Start();
                try
                {
        ...
        public AsyncPageable<InboundNatRule> ListAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Filters the list of <see cref="InboundNatRule" /> for this resource group represented as generic resources. </summary>
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("InboundNatRuleContainer.ListAsGenericResource");
            scope.Start();
            try
            {
                var filters = new ResourceFilterCollection(InboundNatRuleOperations.ResourceType);
