...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class ApplicationSecurityGroupContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, ApplicationSecurityGroup, ApplicationSecurityGroupData>
    {
        ...
        internal ApplicationSecurityGroupContainer(OperationsBase parent) : base(parent)
        {
        ...
        public virtual Response<ApplicationSecurityGroup> CreateOrUpdate(string applicationSecurityGroupName, ApplicationSecurityGroupData parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var operation = StartCreateOrUpdate(applicationSecurityGroupName, parameters, cancellationToken);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="applicationSecurityGroupName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<Response<ApplicationSecurityGroup>> CreateOrUpdateAsync(string applicationSecurityGroupName, ApplicationSecurityGroupData parameters, CancellationToken cancellationToken = default)
        {
            if (applicationSecurityGroupName == null)
            {
                throw new ArgumentNullException(nameof(applicationSecurityGroupName));
            ...
            try
            {
                var operation = await StartCreateOrUpdateAsync(applicationSecurityGroupName, parameters, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="applicationSecurityGroupName"/> or <paramref name="parameters"/> is null. </exception>
        public virtual ApplicationSecurityGroupsCreateOrUpdateOperation StartCreateOrUpdate(string applicationSecurityGroupName, ApplicationSecurityGroupData parameters, CancellationToken cancellationToken = default)
        {
            if (applicationSecurityGroupName == null)
            {
                throw new ArgumentNullException(nameof(applicationSecurityGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("ApplicationSecurityGroupContainer.StartCreateOrUpdate");
            scope.Start();
            try
            {
                var response = _restClient.CreateOrUpdate(Id.ResourceGroupName, applicationSecurityGroupName, parameters, cancellationToken);
                return new ApplicationSecurityGroupsCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, applicationSecurityGroupName, parameters).Request, response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="applicationSecurityGroupName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<ApplicationSecurityGroupsCreateOrUpdateOperation> StartCreateOrUpdateAsync(string applicationSecurityGroupName, ApplicationSecurityGroupData parameters, CancellationToken cancellationToken = default)
        {
            if (applicationSecurityGroupName == null)
            {
                throw new ArgumentNullException(nameof(applicationSecurityGroupName));
            ...
            try
            {
                var response = await _restClient.CreateOrUpdateAsync(Id.ResourceGroupName, applicationSecurityGroupName, parameters, cancellationToken).ConfigureAwait(false);
                return new ApplicationSecurityGroupsCreateOrUpdateOperation(Parent, _clientDiagnostics, Pipeline, _restClient.CreateCreateOrUpdateRequest(Id.ResourceGroupName, applicationSecurityGroupName, parameters).Request, response);
            }
            catch (Exception e)
            {
        ...
        /// <param name="applicationSecurityGroupName"> The name of the application security group. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<ApplicationSecurityGroup> TryGetAsync(string applicationSecurityGroupName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationSecurityGroupContainer.TryGet");
            scope.Start();
            try
        ...
        /// <param name="applicationSecurityGroupName"> The name of the application security group. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public virtual bool DoesExist(string applicationSecurityGroupName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationSecurityGroupContainer.DoesExist");
            scope.Start();
            try
            {
                if (applicationSecurityGroupName == null)
        ...
        /// <param name="applicationSecurityGroupName"> The name of the application security group. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async virtual Task<bool> DoesExistAsync(string applicationSecurityGroupName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationSecurityGroupContainer.DoesExist");
            scope.Start();
            try
        ...
        public Pageable<ApplicationSecurityGroup> List(CancellationToken cancellationToken = default)
        {
            Page<ApplicationSecurityGroup> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("ApplicationSecurityGroupContainer.List");
                scope.Start();
                try
                {
        ...
        public AsyncPageable<ApplicationSecurityGroup> ListAsync(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("ApplicationSecurityGroupContainer.ListAsGenericResource");
            scope.Start();
            try
            {
                var filters = new ResourceFilterCollection(ApplicationSecurityGroupOperations.ResourceType);
