...
namespace DnsManagementClient.Models
{
    ...
    public partial class DnsZoneACreateOrUpdateOperation : Operation<DnsZoneA>
    {
        private readonly OperationOrResponseInternals<DnsZoneA> _operation;

        /// <summary> Initializes a new instance of DnsZoneACreateOrUpdateOperation for mocking. </summary>
        protected DnsZoneACreateOrUpdateOperation()
        {
        }

        internal DnsZoneACreateOrUpdateOperation(ArmResource operationsBase, Response<RecordSetData> response)
        {
