...
namespace DnsManagementClient
{
    ...
    public partial class DnsZoneMXCollection : ArmCollection, IEnumerable<DnsZoneMX>, IAsyncEnumerable<DnsZoneMX>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DnsZoneMXCollection"/> class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal DnsZoneMXCollection(ArmResource parent) : base(parent)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            ClientOptions.TryGetApiVersion(DnsZoneMX.ResourceType, out string apiVersion);
        ...
        public virtual DnsZoneMXCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DnsZoneMXCreateOrUpdateOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<DnsZoneMXCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
        ...
        public virtual Response<DnsZoneMX> GetIfExists(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                if (response.Value == null)
                    return Response.FromValue<DnsZoneMX>(null, response.GetRawResponse());
        ...
        public virtual Response<bool> Exists(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DnsZoneMXCollection.Exists");
            scope.Start();
            try
            {
        ...
        IEnumerator<DnsZoneMX> IEnumerable<DnsZoneMX>.GetEnumerator()
        {
        ...
        IAsyncEnumerator<DnsZoneMX> IAsyncEnumerable<DnsZoneMX>.GetAsyncEnumerator(CancellationToken cancellationToken)
        {
            return GetAllAsync(cancellationToken: cancellationToken).GetAsyncEnumerator(cancellationToken);
        }

        // Builders.
        // public ArmBuilder<Azure.Core.ResourceIdentifier, DnsZoneMX, RecordSetData> Construct() { }
    }
}
