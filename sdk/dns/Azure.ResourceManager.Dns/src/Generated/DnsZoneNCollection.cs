...
namespace DnsManagementClient
{
    ...
    public partial class DnsZoneNCollection : ArmCollection, IEnumerable<DnsZoneN>, IAsyncEnumerable<DnsZoneN>
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly RecordSetsRestOperations _recordSetsRestClient;

        /// <summary> Initializes a new instance of the <see cref="DnsZoneNCollection"/> class for mocking. </summary>
        protected DnsZoneNCollection()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DnsZoneNCollection"/> class. </summary>
        /// <param name="parent"> The resource representing the parent resource. </param>
        internal DnsZoneNCollection(ArmResource parent) : base(parent)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            ClientOptions.TryGetApiVersion(DnsZoneN.ResourceType, out string apiVersion);
        ...
        public virtual DnsZoneNCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DnsZoneNCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                var operation = new DnsZoneNCreateOrUpdateOperation(Parent, response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<DnsZoneNCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string relativeRecordSetName, RecordSetData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
        ...
        public virtual Response<DnsZoneN> Get(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
            ...
            using var scope = _clientDiagnostics.CreateScope("DnsZoneNCollection.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new DnsZoneN(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> is null. </exception>
        public async virtual Task<Response<DnsZoneN>> GetAsync(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> is null. </exception>
        public virtual Response<DnsZoneN> GetIfExists(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
            ...
            using var scope = _clientDiagnostics.CreateScope("DnsZoneNCollection.GetIfExists");
            scope.Start();
            try
            {
                ...
                if (response.Value == null)
                    return Response.FromValue<DnsZoneN>(null, response.GetRawResponse());
                return Response.FromValue(new DnsZoneN(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> is null. </exception>
        public async virtual Task<Response<DnsZoneN>> GetIfExistsAsync(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            if (relativeRecordSetName == null)
            {
                throw new ArgumentNullException(nameof(relativeRecordSetName));
        ...
        public virtual Response<bool> Exists(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DnsZoneNCollection.Exists");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="DnsZoneN" /> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<DnsZoneN> GetAll(int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            Page<DnsZoneN> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("DnsZoneNCollection.GetAll");
                scope.Start();
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new DnsZoneN(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            Page<DnsZoneN> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("DnsZoneNCollection.GetAll");
                scope.Start();
                try
        ...
        /// <param name="recordsetnamesuffix"> The suffix label of the record set name that has to be used to filter the record set enumerations. If this parameter is specified, Enumeration will return only records that end with .&lt;recordSetNameSuffix&gt;. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> An async collection of <see cref="DnsZoneN" /> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<DnsZoneN> GetAllAsync(int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<DnsZoneN>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("DnsZoneNCollection.GetAll");
                scope.Start();
                try
            ...
            async Task<Page<DnsZoneN>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("DnsZoneNCollection.GetAll");
                scope.Start();
                try
        ...
        IEnumerator<DnsZoneN> IEnumerable<DnsZoneN>.GetEnumerator()
        {
        ...
        IAsyncEnumerator<DnsZoneN> IAsyncEnumerable<DnsZoneN>.GetAsyncEnumerator(CancellationToken cancellationToken)
        {
            return GetAllAsync(cancellationToken: cancellationToken).GetAsyncEnumerator(cancellationToken);
        }

        // Builders.
        // public ArmBuilder<Azure.Core.ResourceIdentifier, DnsZoneN, RecordSetData> Construct() { }
    }
}
