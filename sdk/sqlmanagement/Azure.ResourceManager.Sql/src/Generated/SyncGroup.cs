...
namespace Azure.ResourceManager.Sql
{
    ...
    public partial class SyncGroup : ArmResource
    {
        ...
        internal SyncGroup(ArmResource options, SyncGroupData data) : base(options, data.Id)
        {
            ...
            _syncGroupsRestClient = new SyncGroupsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri, apiVersion);
#if DEBUG
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SyncGroup.GetAvailableLocations");
            scope.Start();
            try
            {
