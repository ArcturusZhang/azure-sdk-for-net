...
namespace Azure.ResourceManager.ArtifactSigning.Models
{
    ...
    public static partial class ArmArtifactSigningModelFactory
    {
        ...
        /// <param name="tags"> Resource tags. </param>
        /// <param name="skuName"> Name of the SKU. </param>
        /// <returns> A new <see cref="Models.ArtifactSigningAccountPatch"/> instance for mocking. </returns>
        public static ArtifactSigningAccountPatch ArtifactSigningAccountPatch(IDictionary<string, string> tags = default, ArtifactSigningSkuName? skuName = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
        ...
        public static ArtifactSigningCertificateProfileData ArtifactSigningCertificateProfileData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, CertificateProfileType? profileType = default, bool? includeStreetAddress = default, bool? includeCity = default, bool? includeState = default, bool? includeCountry = default, bool? includePostalCode = default, string identityValidationId = default, ArtifactSigningProvisioningState? provisioningState = default, CertificateProfileStatus? status = default, IEnumerable<ArtifactSigningCertificate> certificates = default)
        {
            return new ArtifactSigningCertificateProfileData(
                ...
                systemData,
                additionalBinaryDataProperties: null,
                profileType is null && includeStreetAddress is null && includeCity is null && includeState is null && includeCountry is null && includePostalCode is null && provisioningState is null && status is null ? default : new CertificateProfileProperties(
        ...
        /// <returns> A new <see cref="Models.ArtifactSigningCertificate"/> instance for mocking. </returns>
        public static ArtifactSigningCertificate ArtifactSigningCertificate(string serialNumber = default, string enhancedKeyUsage = default, string subjectName = default, string thumbprint = default, DateTimeOffset? createOn = default, DateTimeOffset? expireOn = default, ArtifactSigningCertificateStatus? status = default, DateTimeOffset? requestedOn = default, DateTimeOffset? effectiveOn = default, string reason = default, string remarks = default, CertificateRevocationStatus? revocationStatus = default, string failureReason = default)
        {
